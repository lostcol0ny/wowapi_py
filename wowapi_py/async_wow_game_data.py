...
from async_api import AsyncApi, RegionType

import custom_types


@dataclass
class AsyncWowGameDataApi:
    """
    All World of Warcraft Game Data API methods.

    This class provides methods to interact with the World of Warcraft Game Data API asynchronously.
    ...
    Attributes:
        ...
        api: An instance of the AsyncApi class for making API requests.
    """

    client_id: str
    client_secret: str
    api: AsyncApi = field(init=False)

    def __post_init__(self):
        self.api = AsyncApi(self.client_id, self.client_secret)

    @classmethod
    async def create(cls, client_id: str, client_secret: str) -> "AsyncWowGameDataApi":
        instance = cls(client_id, client_secret)
        await instance.api.__aenter__()
        return instance

    async def __aenter__(self) -> "AsyncWowGameDataApi":
        return self
    ...
    async def get_achievements_index(
        self, region: RegionType, locale: str
        ...
        return await self.api.get(resource, region, params=query_params)

    async def get_achievement(
        self, region: RegionType, locale: str, achievement_id: int
    ...
    async def get_achievement_categories_index(
    ...
    async def get_achievement_category(
    ...
    async def get_auction_house_index(
    ...
    async def get_auctions_for_auction_house(
        ...
        query_params = {"namespace": f"dynamic-classic-{region}", "locale": locale}
        return await self.epi.get(resource, region, params=query_params)
    ...
    async def get_commodities(self, region: str, locale: str) -> custom_types.Auctions:
    ...
    async def get_azerite_essences_index(
        self, region: str, locale: str
    ...
    async def get_azerite_essence_media(
    ...
    async def get_connected_realms_index(
    ...
    async def get_conduit_index(
        self, region: str, locale: str
    ) -> custom_types.ConduitIndex:
        """
    ...
    async def get_creature_display_media(
        self,
        region: str,
        locale: str,
        ...
        namespace = f"static-classic-{region}" if is_classic else f"static-{region}"
        query_params = {"namespace": namespace, "locale": locale}
        return await self.api.get(resource, region, param=query_params)

    async def get_creature_families_index(
        self, region: str, locale: str, is_classic: bool = False
    ...
    async def get_creature_family_media(
        self,
        region: str,
        locale: str,
        creature_family_id: int,
    ...
    async def get_creature_types_index(
        self, region: str, locale: str, is_classic: bool = False
    ...
    async def get_guild_crest_components_index(
        self, region: str, locale: str, is_classic: bool = False
    ...
    async def get_guild_crest_border_media(
    ...
    async def get_guild_crest_emblem_media(
    ...
    async def get_item_classes_index(
        self, region: str, locale: str, is_classic: bool = False
    ...
    async def get_item_appearance_sets_index(
        self, region: str, locale: str, is_classic: bool = False
    ...
    async def get_item_appearance_set(
    ...
    async def get_item_appearance_slot_index(
        self, region: str, locale: str
    ) -> List[str]:
        """
    ...
    async def get_item_appearance_slot(
    ...
    async def get_journal_expansions_index(
        self, region: str, locale: str
    ...
    async def get_journal_expansion(
    ...
    async def get_journal_encounters_index(
        self, region: str, locale: str
    ...
    async def get_journal_encounter(
    ...
    async def get_journal_instances_index(
        self, region: str, locale: str
    ...
    async def get_journal_instance(
    ...
    async def get_journal_instance_media(
        self, region: str, locale: str, journal_instance_id: int
    ...
    async def get_modified_crafting_index(
        self, region: str, locale: str
    ...
    async def get_modified_crafting_category_index(
        self, region: str, locale: str
    ...
    async def get_modified_crafting_category(
    ...
    async def get_modified_crafting_reagent_slot_type_index(
        self, region: str, locale: str
    ...
    async def get_modified_crafting_reagent_slot_type(
    ...
    async def get_mounts_index(
        self, region: str, locale: str
    ) -> custom_types.MountsIndex:
        """
    ...
    async def get_mythic_keystone_affixes_index(
        self, region: str, locale: str
    ...
    async def get_mythic_keystone_affix(
    ...
    async def get_mythic_keystone_affix_media(
        self, region: str, locale: str, keystone_affix_id: int
    ...
    async def get_mythic_keystone_dungeons_index(
        self, region: str, locale: str
    ...
    async def get_mythic_keystone_dungeon(
    ...
    async def get_mythic_keystone_periods_index(
        self, region: str, locale: str
    ...
    async def get_mythic_keystone_period(
    ...
    async def get_mythic_keystone_seasons_index(
        self, region: str, locale: str
    ...
    async def get_mythic_keystone_season(
    ...
    async def get_mythic_keystone_leaderboards_index(
        self, region: str, locale: str, connected_realm_id: int
    ...
    async def get_mythic_keystone_leaderboard(
        self,
        region: str,
        locale: str,
        connected_realm_id: int,
    ...
    async def get_mythic_raid_leaderboard(
    ...
    async def get_pets_index(self, region: str, locale: str) -> custom_types.PetsIndex:
        """
    ...
    async def get_pet(self, region: str, locale: str, pet_id: int) -> custom_types.Pet:
        """
    ...
    async def get_pet_abilities_index(
        self, region: str, locale: str
    ...
    async def get_pet_ability_media(
        self, region: str, locale: str, pet_ability_id: int
    ) -> custom_types.GenericMedia:
        """
    ...
    async def get_playable_classes_index(
        self, region: str, locale: str, is_classic: bool = False
    ...
    async def get_playable_class_media(
        self,
        region: str,
        locale: str,
        class_id: int,
    ...
    async def get_pvp_talent_slots(
    ...
    async def get_playable_races_index(
        self, region: str, locale: str, is_classic: bool = False
    ...
    async def get_playable_specializations_index(
        self, region: str, locale: str
    ...
    async def get_playable_specialization(
    ...
    async def get_playable_specialization_media(
        self, region: str, locale: str, spec_id: int
    ) -> custom_types.GenericMedia:
        """
    ...
    async def get_power_types_index(
        self, region: str, locale: str, is_classic: bool = False
    ...
    async def get_professions_index(
        self, region: str, locale: str
    ...
    async def get_profession_media(
        self, region: str, locale: str, profession_id: int
    ) -> custom_types.GenericMedia:
        """
    ...
    async def get_profession_skill_tier(
    ...
    async def get_pvp_seasons_index(
        self, region: str, locale: str
    ...
    async def get_pvp_leaderboards_index(
        self, region: str, locale: str, pvp_season_id: int
    ...
    async def get_pvp_rewards_index(
        self, region: str, locale: str, pvp_season_id: int
    ...
    async def get_quests_index(
        self, region: str, locale: str
    ) -> custom_types.QuestsIndex:
        """
    ...
    async def get_quest(
        self, region: str, locale: str, quest_id: int
    ) -> custom_types.Quest:
        """
    ...
    async def get_quest_categories_index(
        self, region: str, locale: str
    ...
    async def get_quest_areas_index(
        self, region: str, locale: str
    ...
    async def get_quest_types_index(
        self, region: str, locale: str
    ...
    async def get_reputation_factions_index(
        self, region: str, locale: str
    ...
    async def get_reputation_faction(
    ...
    async def get_reputation_tiers_index(
        self, region: str, locale: str
    ...
    async def get_talent_tree_nodes(
    ...
    async def get_pvp_talents_index(
        self, region: str, locale: str
    ...
    async def get_tech_talent_tree_index(
        self, region: str, locale: str
    ...
    async def get_tech_talent_tree(
    ...
    async def get_tech_talent_index(
        self, region: str, locale: str
    ...
    async def get_tech_talent_media(
        self, region: str, locale: str, tech_talent_id: int
    ) -> custom_types.GenericMedia:
        """
    ...
    async def get_title(
        self, region: str, locale: str, title_id: int
    ) -> custom_types.Title:
        """
    ...
    async def get_toy_index(self, region: str, locale: str) -> custom_types.ToyIndex:
        """
    ...
    async def get_toy(self, region: str, locale: str, toy_id: int) -> custom_types.Toy:
        """
        Return a toy by ID.
...
class AsyncWowGameDataApi:
    ...
    @classmethod
    async def create(cls, client_id: str, client_secret: str) -> "AsyncWowGameDataApi":
        api = AsyncApi(client_id, client_secret)
        return cls(api)
